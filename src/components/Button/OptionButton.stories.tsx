...
const meta: Meta<typeof OptionButton> = {
  ...
  argTypes: {
    ...
    state: { control: 'inline-radio', options: ['default', 'accent', 'disabled'] },
  },
...
export const OutlineStates: Story = {
  render: () => (
    <div className="flex items-center gap-4">
      <OptionButton variant="outline" state="default">text</OptionButton>
      <OptionButton variant="outline" state="accent">text</OptionButton>
      <OptionButton variant="outline" state="disabled">text</OptionButton>
    </div>
  ),
}
...
export const SolidStates: Story = {
  render: () => (
    <div className="flex items-center gap-4">
      <OptionButton variant="solid" state="accent">text</OptionButton>
      <OptionButton variant="solid" state="disabled">text</OptionButton>
    </div>
  ),
}
