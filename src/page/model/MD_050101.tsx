...
export function MD_050101() {
  return (
    <div
      ...
      style={{ width: 'var(--layout-viewport-w)', backgroundColor: 'var(--color-bg)' }}
    >
      <Header type="pcMainOn" breadcrumb={['모델', '모델 탐색']} projectName="Public" />
          ...
          <div className="flex flex-col gap-12">
            ...
            <section className="flex flex-col gap-5">
              <div className="flex items-center justify-between">
                <h1 className="text-headline2-bold" style={{ color: 'var(--color-greyscale-900)' }}>
                  모델 탐색
                </h1>
                <div className="flex items-center gap-4" style={{ color: 'var(--color-primary-800)' }}>
              ...
              <p className="text-body1-regular" style={{ color: 'var(--color-greyscale-700)' }}>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <span className="text-body1-regular" style={{ color: 'var(--color-greyscale-800)' }}>
                  총{' '}
                  <span style={{ color: 'var(--color-primary-800)' }}>99</span>건
                </span>
                ...
                {ROWS.map((row, i) => (
                  <div className="flex" key={i}>
                    ...
                    <TableCell
                      ...
                      value={<Label color={STATUS_LABEL[row.status]}>{row.status}</Label>}
                    />
