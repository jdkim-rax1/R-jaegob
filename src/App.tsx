...
const ROUTES: Route[] = [
  { path: '/model/MD_050101', title: 'MD_050101 · 모델 탐색', element: <MD_050101 /> },
  { path: '/model/MD_050102', title: 'MD_050102 · 모델 검사 결과 팝업', element: <MD_050102 /> },
]
...
function Home() {
  return (
    <main className="bg-bg text-fg p-xl min-h-screen font-sans">
      ...
      <p className="text-fg-muted mt-md">디자인 시스템 하네스 — 페이지 미리보기</p>
