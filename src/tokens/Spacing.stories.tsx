...
const LAYOUT: string[] = [
  '--layout-header-h', '--layout-lnb-w', '--layout-lnb-max-w',
  '--layout-filter-w', '--layout-filter-alt-w', '--layout-step-w',
  '--layout-col-gap', '--layout-content-inset-y', '--layout-content-w',
]
...
export const Scale: Story = {
  render: () => (
    <div className="flex flex-col gap-3 bg-bg p-8">
      <h3 className="text-title4-semibold text-fg">Spacing Scale · --spacing × n</h3>
      {SCALE.map((s) => (
...
export const Layout: Story = {
  render: () => (
    <div className="flex flex-col gap-3 bg-bg p-8">
      <h3 className="text-title4-semibold text-fg">Layout Tokens · --layout-*</h3>
